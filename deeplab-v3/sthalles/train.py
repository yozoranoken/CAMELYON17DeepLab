...
envarg.add_argument("--data-dir", type=str, required=True, help="Location of dataset directory.")
envarg.add_argument("--log-dir", type=str, required=True, help="Location of log directory.")
